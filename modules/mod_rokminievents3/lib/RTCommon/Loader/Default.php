<?php
/**
 * @version   $Id: Default.php 6813 2013-01-28 04:28:56Z btowles $
...
class RTCommon_Loader_Default implements RTCommon_Loader
{
    const NAME = 'DEFAULT';
    const PRIORITY = 10;
    /**
    ...
    /**
     * @var array of RTCommon_Loader_Default_Path
     */
    ...
    public function addPath($path, $namespace = null)
    {
        ...
        {
            $this->_paths[$path]= new RTCommon_Loader_Default_Path($path, $namespace);
        }
    }
...
class RTCommon_Loader_Default_Path {
    /**
     * @var string
     */
    private $_namespace;
